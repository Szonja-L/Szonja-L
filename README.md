...
I'm a MSc bioinformatics graduate showcasing my hands-on portfolio of computational biology and data science projects I have completed during my student projects and more recently. I work with real biological datasets to solve problems in genomics, structural biology, and drug discovery. Additionally, I have done data analytics working with nutritional datasets during my internship in an R&D team setting at FrieslandCampina.
...
`Python` `Biopython` `Jupyter` `pandas` `NumPy` `matplotlib` `seaborn`
`PyMOL` `AutoDock Vina` `Galaxy` `NCBI GEO` `RCSB PDB` `Git`
